...
CONFIG_HEADER = $(top_builddir)/src/config/BitMoney-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/BitMoney-config.h.in \
...
ACLOCAL = ${SHELL} /root/Coins/GIT-DEV/BitMoneyV2-bak/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /root/Coins/GIT-DEV/BitMoneyV2-bak/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/Coins/GIT-DEV/BitMoneyV2-bak/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/Coins/GIT-DEV/BitMoneyV2-bak/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /root/Coins/GIT-DEV/BitMoneyV2-bak/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = BitMoney
PACKAGE_BUGREPORT = www.BitMoney.ws
PACKAGE_NAME = BitMoney Core
PACKAGE_STRING = BitMoney Core 2.1.0
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/Coins/GIT-DEV/BitMoneyV2-bak
abs_srcdir = /root/Coins/GIT-DEV/BitMoneyV2-bak
abs_top_builddir = /root/Coins/GIT-DEV/BitMoneyV2-bak
abs_top_srcdir = /root/Coins/GIT-DEV/BitMoneyV2-bak
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/Coins/GIT-DEV/BitMoneyV2-bak/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_BitMoney_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_BitMoney_coverage.info test_BitMoney.info
...
src/config/BitMoney-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/BitMoney-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/BitMoney-config.h
$(top_srcdir)/src/config/BitMoney-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/BitMoney-config.h src/config/stamp-h1
...
#test_BitMoney.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_BitMoney -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_BitMoney_filtered.info: test_BitMoney.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_BitMoney_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_BitMoney_coverage.info: baseline_filtered_combined.info test_BitMoney_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_BitMoney_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_BitMoney_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_BitMoney_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_BitMoney.coverage/.dirstamp:  test_BitMoney_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_BitMoney.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_BitMoney.coverage/ total.coverage/ $(OSX_APP)
