                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BitMoney from zBIT"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBIT"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zsnd));
