/* src/config/BitMoney-config.h.  Generated from BitMoney-config.h.in by configure.  */
/* src/config/BitMoney-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BitMoney_CONFIG_H

#define BitMoney_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.BitMoney.ws"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitMoney Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitMoney Core 2.1.1.0"
...
#define PACKAGE_VERSION "2.1.1.0"
