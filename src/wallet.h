...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 BitMoney at the same time
...
enum ZerocoinSpendStatus {
    ZBitMoney_SPEND_OKAY = 0,                            // No error
    ZBitMoney_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZBitMoney_WALLET_LOCKED = 2,                         // Wallet was locked
    ZBitMoney_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZBitMoney_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZBitMoney_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZBitMoney_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZBitMoney_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZBitMoney_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZBitMoney_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZBitMoney_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZBitMoney_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZBitMoney_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZBitMoney_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZBitMoney_SPENT_USED_ZBitMoney = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZBitMoneyAutoBackups(bool fEnabled)
    {
