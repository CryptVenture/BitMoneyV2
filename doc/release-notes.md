...
BitMoney Core version *version* is now available from:

  <https://github.com/eastcoastcrypto/BitMoney/releases>

Please report bugs using the issue tracker at github:

  <https://github.com/eastcoastcrypto/BitMoneyita/issues>
